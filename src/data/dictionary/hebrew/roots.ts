...
const ROOTS = {
  ...
  chazah: {
    ...
    englishNatural: 'to see',
    type: 'verb',
    description: 'to see, to behold, to gaze, to have a vision (Aramaic)',
    related: ['raah', 'machazeh', 'khezev'],
  },
  khezev: {
    hebrew: 'חזו',
  ...
  hava_aramaic: {
    ...
    englishNatural: 'to be',
    type: 'verb',
    description: 'to be, to exist, to become (Aramaic cognate of Hebrew hayah)',
    related: ['hayah'],
  },
  khayva: {
    hebrew: 'חיוא',
    transliteration: 'khayva',
    englishLiteral: 'beast',
    englishNatural: 'beast',
    type: 'noun',
  ...
  salaq: {
    ...
    type: 'verb',
    description: 'to come up, to go up, to ascend (Aramaic)',
    related: ['alah'],
  },
  shena: {
    hebrew: 'שנא',
    ...
    type: 'verb',
    description: 'to be different, to change, to alter (Aramaic; not related to shanah "year")',
  },
  da: {
    hebrew: 'דא',
    transliteration: 'da',
  ...
  di: {
    ...
    englishNatural: 'of',
    type: 'particle',
    description: 'of, which, that, who (relative particle, Aramaic)',
    related: ['asher'],
  },
  merat: {
    hebrew: 'מרט',
  ...
  ara: {
    ...
    englishNatural: 'earth',
    type: 'noun',
    description: 'earth, ground, land (Aramaic)',
    related: ['eretz'],
  },
  ara_lower: {
    hebrew: 'ארע',
  ...
  saggi: {
    ...
    englishNatural: 'much',
    type: 'adjective',
    description: 'much, many, great, abundant (Aramaic)',
    related: ['rav', 'rabah'],
  },
  bathar: {
    hebrew: 'באתר',
  ...
  shelet: {
    ...
    related: ['mashal', 'sholtan'],
  },
  reviai: {
    hebrew: 'רביעי',
    transliteration: 'reviai',
    englishLiteral: 'fourth',
    englishNatural: 'fourth',
    type: 'adjective',
    description: 'fourth (Aramaic)',
    related: ['revii'],
  },
  dechal: {
    hebrew: 'דחל',
    transliteration: 'dechal',
    englishLiteral: 'to be_dreadful',
    englishNatural: 'to be dreadful',
    type: 'adjective',
    description: 'dreadful, frightful, fearful (Aramaic)',
    related: ['yare'],
  },
  emtan: {
    hebrew: 'אימתן',
  ...
  yattir: {
    ...
    type: 'adjective',
    description: 'exceedingly, extremely, very, surpassing (Aramaic)',
    related: ['meod'],
  },
  parzel: {
    hebrew: 'פרזל',
  ...
  deqaq: {
    ...
    type: 'verb',
    description: 'to crush, to break in pieces, to pulverize (Aramaic)',
    related: ['daqaq'],
  },
  shear: {
    hebrew: 'שאר',
  ...
  qodam: {
    ...
    type: 'preposition',
    description: 'before, in front of (Aramaic)',
    related: ['qedem', 'liphnei'],
  },
  qeren: {
    hebrew: 'קרן',
