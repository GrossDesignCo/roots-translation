...
const ROOTS = {
  ...
  rav: {
    ...
    englishNatural: 'many',
    type: 'adjective',
    description: 'many, much, great, numerous; (Aramaic: rab)',
    related: ['rav_noun', 'rabah', 'gadol'],
  },
  am: {
    hebrew: 'עם',
    transliteration: 'am',
  ...
  nahar: {
    ...
    type: 'noun',
    description: 'river, stream (Hebrew and Aramaic)',
  },
  parad: {
    hebrew: 'פרד',
  ...
  rum_verb: {
    hebrew: 'רום',
    transliteration: 'rum',
    englishLiteral: 'to raise',
    englishNatural: 'to raise',
    type: 'verb',
    related: ['rum'],
    description: 'to be high, to rise, to raise up; hiphil: to lift up, exalt',
  },
  nasa: {
    hebrew: 'נשא',
  ...
  ayin_eye: {
    ...
    englishNatural: 'eye',
    type: 'noun',
    description: 'eye, sight, appearance (Hebrew and Aramaic)',
    related: ['panah'],
  },
  pi: {
    hebrew: 'פי',
  ...
  hi: {
    ...
    englishNatural: 'she',
    type: 'pronoun',
    description: 'third person feminine singular pronoun (Hebrew and Aramaic)',
  },
  ...
  ribbo: {
    ...
    related: ['revavah'] as const,
  },
  revavah: {
    hebrew: 'רְבָבָה',
    transliteration: 'revavah',
    englishLiteral: 'ten_thousand',
    englishNatural: 'ten-thousand',
    type: 'noun',
    description: 'myriad, ten thousand — feminine noun form',
    related: ['ribbo', 'rabah'] as const,
  },
  yamin: {
    hebrew: 'ימין',
  ...
  asar: {
    ...
    englishNatural: 'ten',
    type: 'numeral',
    description: 'ten, decade (Hebrew and Aramaic)',
    related: ['eser'],
  },
  baqa: {
    hebrew: 'בקע',
  ...
  dov: {
    ...
    englishNatural: 'bear',
    type: 'noun',
    description: 'bear (the animal, Aramaic and Hebrew)',
  },
  shen: {
    hebrew: 'שן',
    transliteration: 'shen',
    englishLiteral: 'tooth',
    englishNatural: 'tooth',
    type: 'noun',
    description: 'tooth (Aramaic and Hebrew)',
  },
  namer: {
    hebrew: 'נמר',
    transliteration: 'namer',
    englishLiteral: 'leopard',
    englishNatural: 'leopard',
    type: 'noun',
    description: 'leopard (Aramaic and Hebrew)',
  },
  qeren: {
    hebrew: 'קרן',
    ...
    englishNatural: 'horn',
    type: 'noun',
    description: 'horn (Aramaic and Hebrew)',
  },
  daqaq: {
    hebrew: 'דקק',
  ...
  liphnei: {
    ...
    type: 'preposition',
    description: 'before, in front of, in the presence of (Hebrew)',
  },
  levush: {
    hebrew: 'לבוש',
    transliteration: 'levush',
    englishLiteral: 'garment',
    englishNatural: 'garment',
    type: 'noun',
    description: 'garment, clothing, raiment (Aramaic and Hebrew)',
  },
  sear: {
    hebrew: 'שער',
    ...
    englishNatural: 'hair',
    type: 'noun',
    description: 'hair (Aramaic and Hebrew)',
  },
  galgal: {
    hebrew: 'גלגל',
    ...
    englishNatural: 'wheel',
    type: 'noun',
    description: 'wheel (Aramaic and Hebrew)',
  },
  sheleg: {
    hebrew: 'שלג',
  ...
  atiq: {
    ...
    type: 'adjective',
    description: 'ancient, removed, old (Hebrew)',
  },
  sepher: {
    hebrew: 'ספר',
  ...
  nazal: {
    ...
    type: 'verb',
    description: 'to flow, to trickle, to pour down (Hebrew)',
  },
  sharet: {
    hebrew: 'שרת',
    transliteration: 'sharet',
    englishLiteral: 'to minister',
    englishNatural: 'to minister',
    type: 'verb',
    description: 'to minister, to serve, to attend (Hebrew)',
  },
  pathach: {
    hebrew: 'פתח',
  ...
  avshalom: {
    ...
    type: 'noun',
    description:
      'proper name, son of David; from av (father) + shalom (peace)',
    related: ['av', 'shalom'],
  },
  quts: {
    hebrew: 'קוץ',
    transliteration: 'quts',
    englishLiteral: 'to awake',
    englishNatural: 'to awake',
    type: 'verb',
    description: 'to awake, to wake up, to rouse oneself from sleep',
    related: ['yashen'],
  },
  samakh: {
    hebrew: 'סמך',
    transliteration: 'samakh',
  ...
  selah: {
    ...
    type: 'interjection',
    description:
      'liturgical or musical notation in the Psalms; possibly a pause for reflection or a musical interlude',
  },
  yasha: {
    hebrew: 'ישע',
    transliteration: 'yasha',
    englishLiteral: 'to save',
  ...
  lechi: {
    ...
    englishNatural: 'cheek',
    type: 'noun',
    description: 'cheek, jaw, jawbone',
  },
  rabab: {
    hebrew: 'רבב',
    transliteration: 'rabab',
    englishLiteral: 'to be_many',
    englishNatural: 'to be-many',
    type: 'verb',
    description:
  ...
  qadosh: {
    ...
    englishNatural: 'holy',
    type: 'adjective',
    description: 'holy, sacred, set apart; adjective form of qadash',
    related: ['qadash', 'qodesh'],
  },
  shuvah: {
    hebrew: 'שׁוּבָה',
    ...
    type: 'noun',
    description: 'returning, repentance; noun form from shuv (to return)',
    related: ['shuv'],
  },
  nachat: {
    hebrew: 'נַחַת',
  ...
  shaqat: {
    ...
    englishLiteral: 'to be_quiet',
    englishNatural: 'to be-quiet',
    type: 'verb',
    description: 'to be quiet, to be undisturbed, to be at rest, to be still',
  },
  batach: {
    hebrew: 'בָּטַח',
    transliteration: 'batach',
    englishLiteral: 'to trust',
  ...
  gevurah: {
    ...
    englishLiteral: 'might',
    englishNatural: 'might',
    type: 'noun',
    description: 'might, strength, power, valor; noun form from gavar (to prevail)',
    related: ['gavar', 'gibbor'],
  },
  // Psalm 46 additions
  korach: {
    hebrew: 'קֹרַח',
    ...
    type: 'noun',
    description: 'proper name meaning "bald" or "ice"; a Levitical family of temple musicians',
  },
  alamot: {
    hebrew: 'עֲלָמוֹת',
    ...
    type: 'noun',
    description:
      'maidens, young women; as a musical term, likely a high-pitched soprano register or style',
  },
  machaseh: {
    hebrew: 'מַחֲסֶה',
    transliteration: 'machaseh',
    englishLiteral: 'refuge',
    englishNatural: 'refuge',
    type: 'noun',
    description: 'refuge, shelter, a place of protection',
  },
  oz: {
    hebrew: 'עֹז',
    transliteration: 'oz',
    ...
    englishNatural: 'strength',
    type: 'noun',
    description: 'strength, might, power, boldness',
  },
  ezrah: {
    hebrew: 'עֶזְרָה',
    ...
    englishNatural: 'help',
    type: 'noun',
    description: 'help, assistance, aid',
  },
  tsarah: {
    hebrew: 'צָרָה',
    ...
    englishNatural: 'distress',
    type: 'noun',
    description: 'distress, trouble, straits, adversity',
  },
  mur: {
    hebrew: 'מוּר',
    transliteration: 'mur',
    englishLiteral: 'to change',
    englishNatural: 'to change',
    type: 'verb',
    description: 'to change, exchange; in hiphil: to shake, remove, change place',
  },
  mut_totter: {
    hebrew: 'מוֹט',
    transliteration: 'mut',
    englishLiteral: 'to totter',
    englishNatural: 'to totter',
    type: 'verb',
    description: 'to totter, shake, slip, be moved; of mountains shaking or foundations being dislodged',
  },
  hamah: {
    hebrew: 'הָמָה',
    transliteration: 'hamah',
    englishLiteral: 'to roar',
    englishNatural: 'to roar',
    type: 'verb',
    description: 'to roar, growl, murmur, be in uproar; of waters crashing, crowds in tumult',
  },
  chamar_foam: {
    hebrew: 'חָמַר',
    transliteration: 'chamar',
    englishLiteral: 'to foam',
    englishNatural: 'to foam',
    type: 'verb',
    description: 'to foam, surge, ferment, boil; of turbulent waters',
    related: ['chamar'],
  },
  raash: {
    hebrew: 'רָעַשׁ',
    transliteration: 'raash',
    englishLiteral: 'to quake',
    englishNatural: 'to quake',
    type: 'verb',
    description: 'to quake, shake, tremble; of the earth or mountains shaking',
  },
  gaavah: {
    hebrew: 'גַּאֲוָה',
    transliteration: 'gaavah',
    englishLiteral: 'swelling',
    englishNatural: 'swelling',
    type: 'noun',
    description: 'swelling, rising, majesty, pride; of waves rising or divine majesty',
  },
  // Exodus 20:13-17 additions (Ten Commandments)
  ratsach: {
    hebrew: 'רצח',
    transliteration: 'ratsach',
    englishLiteral: 'to murder',
    englishNatural: 'to murder',
    type: 'verb',
    description: 'to murder, slay, kill unlawfully; distinct from harag (to kill in general)',
  },
  naaf: {
    hebrew: 'נאף',
    transliteration: 'naaf',
    englishLiteral: 'to commit_adultery',
    englishNatural: 'to commit-adultery',
    type: 'verb',
    description: 'to commit adultery, be unfaithful',
  },
  ganav: {
    hebrew: 'גנב',
    transliteration: 'ganav',
    englishLiteral: 'to steal',
    englishNatural: 'to steal',
    type: 'verb',
    description: 'to steal, take by stealth',
  },
  ed_witness: {
    hebrew: 'עֵד',
    transliteration: 'ed',
    englishLiteral: 'witness',
    englishNatural: 'witness',
    type: 'noun',
    description: 'witness, testimony, one who testifies',
  },
  sheqer: {
    hebrew: 'שֶׁקֶר',
    ...
    type: 'noun',
    description: 'falsehood, deception, lie, false thing',
  },
  amah_maid: {
    hebrew: 'אָמָה',
    transliteration: 'amah',
  ...
  // Exodus 20:10-12 additions
  shabbat: {
    hebrew: 'שַׁבָּת',
    transliteration: 'shabbat',
    englishLiteral: 'Sabbath',
    englishNatural: 'Sabbath',
    type: 'noun',
    description: 'Sabbath, rest day; noun form from shavat (to cease/rest)',
    related: ['shavat'],
  },
  arakh_long: {
    hebrew: 'אָרַךְ',
    transliteration: 'arakh',
    englishLiteral: 'to be_long',
    englishNatural: 'to be-long',
    type: 'verb',
    description: 'to be long, to prolong, to lengthen; distinct from arakh (to arrange)',
  },
  naqah: {
    hebrew: 'נָקָה',
    transliteration: 'naqah',
    englishLiteral: 'to be_clean',
    englishNatural: 'to be-clean',
    type: 'verb',
    description: 'to be clean, innocent, free from guilt; in piel: to leave unpunished, to acquit',
  },
  pesel: {
    hebrew: 'פֶּסֶל',
    transliteration: 'pesel',
    englishLiteral: 'carved_image',
    englishNatural: 'carved-image',
    type: 'noun',
    description: 'carved image, idol, graven image; from pasal (to hew, carve)',
  },
  temunah: {
    hebrew: 'תְּמוּנָה',
    ...
    englishNatural: 'likeness',
    type: 'noun',
    description: 'likeness, form, image, representation',
  },
  qanna: {
    hebrew: 'קַנָּא',
    ...
    type: 'adjective',
    description: 'jealous, zealous; used exclusively of God',
    related: ['qanah'],
  },
  shillesh: {
    hebrew: 'שִׁלֵּשׁ',
    ...
    type: 'noun',
    description: 'third generation, those of the third degree',
  },
  ribbea: {
    hebrew: 'רִבֵּעַ',
    ...
    type: 'noun',
    description: 'fourth generation, those of the fourth degree',
  },
  sane: {
    hebrew: 'שָׂנֵא',
    transliteration: 'sane',
    englishLiteral: 'to hate',
    englishNatural: 'to hate',
    type: 'verb',
    description: 'to hate, detest',
  },
  ahav: {
    hebrew: 'אָהַב',
    transliteration: 'ahav',
    englishLiteral: 'to love',
    englishNatural: 'to love',
    type: 'verb',
    description: 'to love, have affection for',
  },
  mitsvah: {
    hebrew: 'מִצְוָה',
    transliteration: 'mitsvah',
    englishLiteral: 'commandment',
    englishNatural: 'commandment',
    type: 'noun',
    description: 'commandment, command, ordinance',
  },
  shofar: {
    hebrew: 'שׁוֹפָר',
    ...
    englishNatural: 'horn',
    type: 'noun',
    description: 'ram\'s horn, trumpet, shofar; used for signals, war, and worship',
  },
  nua: {
    hebrew: 'נוּעַ',
    transliteration: 'nua',
  ...
  rachoq: {
    ...
    englishNatural: 'far',
    type: 'adjective',
    description: 'far, distant, remote; as adverb: afar, at a distance',
  },
  nasah: {
    hebrew: 'נָסָה',
    transliteration: 'nasah',
    englishLiteral: 'to test',
    englishNatural: 'to test',
    type: 'verb',
    description: 'to test, try, prove, put to the test',
  },
  baavur: {
    hebrew: 'בַּעֲבוּר',
    ...
    type: 'preposition',
    description: 'for the sake of, in order that, because of',
  },
  al_not: {
    hebrew: 'אַל',
    transliteration: 'al',
    ...
    englishNatural: 'not',
    type: 'adverb',
    description: 'not, do not; negative particle used with jussive/cohortative (distinct from al/over עַל)',
  },
  // Isaiah 6:8-13 additions
  shaman: {
    hebrew: 'שׁמן',
    transliteration: 'shaman',
    englishLiteral: 'to make_fat',
    englishNatural: 'to make-fat',
    type: 'verb',
    description: 'to be or make fat, gross, dull; hiphil: to make fat/insensitive',
  },
  shaa: {
    hebrew: 'שׁעע',
  ...
  rapha: {
    ...
    englishLiteral: 'to heal',
    englishNatural: 'to heal',
    type: 'verb',
    description: 'to heal, cure, restore to health; distinct from raphah (to sink/relax)',
  },
  matay: {
    hebrew: 'מָתַי',
    ...
    englishNatural: 'when',
    type: 'adverb',
    description: 'when? how long? (interrogative of time)',
  },
  shaah_desolate: {
    hebrew: 'שׁאה',
    transliteration: 'shaah',
    englishLiteral: 'to be_desolate',
    englishNatural: 'to be-desolate',
    type: 'verb',
    description: 'to crash into ruins, be desolate, laid waste',
    related: ['shemamah'],
  },
  shemamah: {
    hebrew: 'שְׁמָמָה',
    ...
    englishNatural: 'desolation',
    type: 'noun',
    description: 'desolation, waste, horror; noun form of shamem',
    related: ['shaah_desolate'],
  },
  rachaq: {
    hebrew: 'רחק',
    transliteration: 'rachaq',
    englishLiteral: 'to be_far',
    englishNatural: 'to be-far',
    type: 'verb',
    description: 'to be or become far, distant; piel: to remove far away',
    related: ['rachoq'],
  },
  qerev: {
    hebrew: 'קֶרֶב',
    ...
    englishNatural: 'midst',
    type: 'noun',
    description: 'midst, inner part, among, within',
  },
  asiriyyah: {
    hebrew: 'עֲשִׂרִיָּה',
  ...
  elah: {
    ...
    englishLiteral: 'terebinth',
    englishNatural: 'terebinth',
    type: 'noun',
    description: 'terebinth tree, a large deciduous tree',
  },
  allon: {
    hebrew: 'אַלּוֹן',
  ...
  shalekhet: {
    hebrew: 'שַׁלֶּכֶת',
    transliteration: 'shalekhet',
    englishLiteral: 'casting_off',
    englishNatural: 'casting-off',
    type: 'noun',
    description: 'a casting off, felling (of leaves from a tree)',
    related: ['shalach'],
  },
  matsevet: {
    hebrew: 'מַצֶּבֶת',
