...
export const exodus_12_30: Verse = {
  meta: {
    book: 'Exodus',
    chapter: 12,
    verse: 30,
  ...
  words: [
    ...
    {
      hebrew: 'עֲבָדָיו֙',
      transliteration: 'avadav',
      englishLiteral: 'servants-his',
      englishNatural: 'his servants',
      root: 'eved',
      suffixes: ['av'],
      order: 6,
      morphology: {
